...
`;
  ...
  return (
    <div id="prompt_lab_container" className="space-y-8 animate-fade-in">
      {/* Design Brief Header */}
      <div className="bg-white p-6 sm:p-8 rounded-[32px] border border-zinc-200 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        <div className="space-y-2">
          ...
          <h3 className="text-2xl font-black text-zinc-950 tracking-tight uppercase flex items-center gap-2">
            <Sparkles className="h-5 w-5 text-lime-500 fill-lime-300" />
        ...
        <div className="bg-zinc-50 border border-zinc-200/80 p-4.5 rounded-2xl text-[10px] text-zinc-500 space-y-1.5 shrink-0 max-w-xs">
          <p className="font-extrabold text-zinc-900 uppercase tracking-widest flex items-center gap-1.5 leading-none">
            <Lightbulb className="h-3.5 w-3.5 text-lime-500" /> PROMPT BUILDER HINTS
          </p>
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="bg-zinc-900 rounded-3xl p-6 border border-zinc-950 text-zinc-300 space-y-5 shadow-sm">
            <div className="flex items-center justify-between border-b border-zinc-850 pb-3.5">
              ...
              >
                <Clipboard className="h-3 w-3" /> Save Code
              </button>
            </div>
            ...
            >
              {loading ? (
                <History className="h-4 w-4 animate-spin text-zinc-950" />
              ) : (
          ...
          {(aiOutput || error || loading) && (
            <div className="bg-white rounded-3xl border border-zinc-200 shadow-xs p-6 space-y-4">
              <div className="flex items-center justify-between border-b border-zinc-100 pb-3">
                <span className="text-[10px] font-black text-zinc-850 uppercase tracking-widest flex items-center gap-1.5">
                  <Cpu className="h-3.5 w-3.5 text-zinc-800" />
              ...
              {loading && (
                <div className="py-8 text-center flex flex-col items-center gap-3">
                  <div className="relative">
                    ...
                    <Sparkles className="h-3.5 w-3.5 text-lime-500 absolute top-2 left-2 animate-pulse" />
                  </div>
              ...
              {error && (
                <div className="text-red-700 text-xs bg-red-50 p-3.5 rounded-xl border border-red-150 flex items-start gap-2">
